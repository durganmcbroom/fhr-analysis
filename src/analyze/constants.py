...
# src/analyze/constants.py -> repo root. Correct only for an editable install,
# which is what setup.sh does; a copied install would point somewhere useless.
