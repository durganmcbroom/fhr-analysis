...
FUNET_CONFIG = os.path.join(PROJECT_DIR, "lib/funet/models/funet-v10/fetal-config.yaml")
FUNET_MODEL_PATH = os.path.join(PROJECT_DIR, "lib/funet/models/funet-v10/model_best.pt")
